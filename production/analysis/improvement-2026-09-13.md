...
カスタムサムネイルの操作でYouTubeから「カスタム サムネイルを追加するには、電話番号を確認してください。」と表示されたため、3枚とも未反映。[本人確認ページ](https://www.youtube.com/verify)は電話番号入力前の状態で開いてある。本人確認の完了後に適用する。関連動画リンクも、子ども向け動画では無効とUIに表示されたため設定していない。
